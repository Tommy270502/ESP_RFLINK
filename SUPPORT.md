...
- Host tool and transport used: CLI, SDK, local web workbench, firmware browser dashboard; USB serial, HTTP, WebSocket, or BLE.
...
The local web workbench can export the same support report from the selected connection.
